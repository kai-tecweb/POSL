...
**Last Updated**: 2025年11月18日 00:45  
**Status**: ✅ Production Ready

## 🌐 本番環境URL
**メインサイト**: http://18.179.104.143/

### 主要ページ
- **ダッシュボード**: http://18.179.104.143/dashboard
- **投稿ログ**: http://18.179.104.143/logs
- **設定管理**: http://18.179.104.143/settings/*
...
│  └─ Backend (/api/) → localhost:3001/dev/│
└────────────────────────────────────────┘
┌─ Application Layer ────────────────────┐
│  ┌─ PM2 Management                     │
│  │  └─ posl-frontend (Next.js)         │
│  └─ Manual Backend                     │
...
├── logs/page.tsx (Post logs) ⭐ NEW
├── settings/
│   ├── prompt/page.tsx
│   ├── tone/page.tsx
│   ├── trends/page.tsx
│   └── [other settings]/page.tsx
└── api/
    └── posts/logs/route.ts (API route)
```
